...
def parseargs(argv=None):
    ...
    parser = argparse.ArgumentParser(
        prog="sitk-lmreg",
        description="Landmark-based registration using corresponding point files.",
    )
    ...
    parser.add_argument(
        "output_tfm",
        nargs="*",
        help="Output transform path. Default derives from the moving points filename.",
    )
    parser.add_argument(
        "--fixed",
        "-f",
    ...
    parser.add_argument(
        ...
        dest="overlay",
        default="",
        help="Overlay image output file.",
    )
...
def usage():
    ...
    print("Usage: sitk-lmreg [options] <fixed.pts> <moving.pts> [output.tfm]")
