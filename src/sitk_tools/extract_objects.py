...
def parse_args(argv=None):
    ...
    parser = argparse.ArgumentParser(
        prog="sitk-extract-objects",
        description="Extract the N largest connected objects from a binary mask.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help="Radius for the binary fill-hole filter.",
    )
...
def main(argv=None):
    ...
    if len(args.filenames) == 0:
        print("Error: missing input mask image")
        return 1
